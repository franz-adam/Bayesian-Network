...
class ProbabilityTests(unittest.TestCase):
    ...
    def test_probability_setup(self):
        ...
        # test H distribution͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
        ...
        # test C distribution͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
        security_system = set_probability(make_security_system_net())
        ...
        # test M distribution͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
        security_system = set_probability(make_security_system_net())
        ...
        # test B distribution͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
        security_system = set_probability(make_security_system_net())
        ...
        # Q distribution͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
        # can't test exact probabilities because͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
        # order of probabilities is not guaranteed͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
    ...
    def test_games_network(self):
        ...
        # Now testing that all nodes in the games network have proper probability distributions.͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
        # Note that all nodes have to be named predictably for tests to run correctly.͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁

        # First testing team distributions.͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
        # You can check this for all teams i.e. A,B,C (by replacing the first line for 'B','C')͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
        ...
        # Now testing match distributions.͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
        # You can check this for all matches i.e. AvB,BvC,CvA (by replacing the first line)͏󠄂͏️͏󠄌͏󠄎͏󠄎͏󠄊͏󠄁
